...
docker build -t "${DOCKER_USERNAME}/prolabel:latest" .
docker build -t "${DOCKER_USERNAME}/prolabel:$1" .

docker push "${DOCKER_USERNAME}/prolabel:latest"
docker push "${DOCKER_USERNAME}/prolabel:$1"
